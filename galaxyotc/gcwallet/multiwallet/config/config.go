...
func NewDefaultConfig(datadir string, coinTypes map[wallet.CoinType]bool, params *chaincfg.Params) *Config {
	cfg := &Config{
	...
	mockDB := boltdb.NewBoltMultiwalletDatastore(datadir)
