...
type Wallet interface {
	...
	Spend(amount string, addr btc.Address, feeLevel FeeLevel, referenceID string) (*chainhash.Hash, error)
	...
	EstimateSpendFee(amount string, feeLevel FeeLevel) (uint64, error)
