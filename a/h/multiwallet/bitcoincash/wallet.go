...
import (
	...
	"gcwallet/multiwallet/bitcoincash/exchangerates"
...
func NewBitcoinCashWallet(cfg config.CoinConfig, mnemonic string, params *chaincfg.Params, proxy proxy.Dialer, cache cache.Cacher, disableExchangeRates bool) (*BitcoinCashWallet, error) {
	...
	if !disableExchangeRates {
		exchangeRates = exchangerates.NewBitcoinCashPriceFetcher(proxy)
	}
...
func (w *BitcoinCashWallet) Transactions(transactionType, sort, offset, limit int) ([]wi.Txn, int32, error) {
