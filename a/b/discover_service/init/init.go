...
import (
	...
	"galaxyotc/gc_services/discover_service/api"
	"galaxyotc/gc_services/discover_service/service"
...
func init() {
	...
	config.DefaultViper()
	// 当前服务配置
	config.SpecifyViper("discover_service", "toml", utils.GetConfigPath())
	...
	serviceName := viper.GetString("discover_service.name")
