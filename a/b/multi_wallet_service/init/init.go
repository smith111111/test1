...
import (
	...
	"galaxyotc/gc_services/multi_wallet_service/service"
...
func init() {
	// 加载服务配置
	config.SpecifyViper("multi_wallet_service", "toml", utils.GetConfigPath())
	...
	serviceName := viper.GetString("multi_wallet_service.name")
