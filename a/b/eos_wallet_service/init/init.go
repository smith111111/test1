...
import (
	...
	"galaxyotc/gc_services/eos_wallet_service/service"
...
func init() {
	// 加载服务配置
	config.SpecifyViper("eos_wallet_service", "toml", utils.GetConfigPath())
	...
	serviceName := viper.GetString("eos_wallet_service.name")
