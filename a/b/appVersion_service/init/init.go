...
import (
	...
	"galaxyotc/gc_services/appVersion_service/api"
	"galaxyotc/gc_services/appVersion_service/service"
...
func init() {
	...
	config.DefaultViper()
	// 当前服务配置
	config.SpecifyViper("appVersion_service", "toml", utils.GetConfigPath())
	...
	serviceName := viper.GetString("appVersion_service.name")
